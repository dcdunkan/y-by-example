...
// There are three "standard" commands: <code>start</code>, <code>help</code>, and <code>settings</code>.
// Official Telegram clients even provides buttons just to send these commands.
// So, they're special, we could say.

// <code>start</code> is the first command every user of your bot will use for the first time.
...
// Now, <code>help</code> and <code>settings</code> ...you know what they are for.
